package com.project.starwarsapi.application.exceptions;

import com.project.starwarsapi.config.MessageLocaleService;
...
public class StarWarsExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        String userMessage = messageLocaleService.getMessage("invalid.message", null, LocaleContextHolder.getLocale());
    ...
    private List<Error>createErrorMessagBody(BindingResult bindingResult) {
        ...
        for (FieldError fieldError : bindingResult.getFieldErrors()) {
            String userMessage = messageLocaleService.getMessage(fieldError, LocaleContextHolder.getLocale());
